...
<<<<<<< HEAD:2_backend/public/registration4.js
proceedBtn.onclick = function (e) {
  ...
  if (validateForm()) {
    ...
    localStorage.setItem("personal_code", personalInput.value.trim());
    localStorage.setItem("phone_number", phoneInput.value.trim());
    localStorage.setItem("home_code", homeInput.value.trim());
    localStorage.setItem("landline_number", landlineInput.value.trim());
    localStorage.setItem("personal_email", emailInput.value.trim());
    ...
    localStorage.setItem("address_unit", unitInput.value.trim());
    localStorage.setItem("address_building", buildingInput.value.trim());
    localStorage.setItem("address_street", streetInput.value.trim());
    localStorage.setItem("address_subdivision", subdivisionInput.value.trim());
    localStorage.setItem("address_barangay", barangayInput.value.trim());
    localStorage.setItem("address_city", cityInput.value.trim());
    localStorage.setItem("address_province", provinceInput.value.trim());
    localStorage.setItem("address_country", countryInput.value.trim());
    localStorage.setItem("address_zip_code", zipCode.value.trim());

    // If alternative address is shown and filled, save those too
    if (!isAlternativeCheckbox.checked) {
      ...
      localStorage.setItem("alt_address_unit", altUnitInput.value.trim());
      localStorage.setItem("alt_address_building", altBuildingInput.value.trim());
      localStorage.setItem("alt_address_street", altStreetInput.value.trim());
      localStorage.setItem("alt_address_subdivision", altSubdivisionInput.value.trim());
      localStorage.setItem("alt_address_barangay", altBarangayInput.value.trim());
      localStorage.setItem("alt_address_city", altCityInput.value.trim());
      localStorage.setItem("alt_address_province", altProvinceInput.value.trim());
      localStorage.setItem("alt_address_country", altCountryInput.value.trim());
      localStorage.setItem("alt_address_zip_code", altZipCode.value.trim());
    }
...
>>>>>>> main:1_frontend/Registration-Customer/registration4.js
});
